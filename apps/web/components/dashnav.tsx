...
const Dashnav = (props: dashNavProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-full bg-logoicon-500 h-[50px] w-[50px] text-black flex justify-center items-center">
        <img src={props.profile!} className="h-full w-full rounded-full" />
      </div>
    </nav>
  );
};
