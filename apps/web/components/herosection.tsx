  ...
  return (
    <div className="flex flex-col md:p-20 w-full h-[80vh] md:h-[80vh] justify-center items-center p-8 bg-[#0F1419] bg-[linear-gradient(135deg,rgba(159,122,234,0.2)_0%,#0F1419_50%,rgba(8,199,222,0.1)_100%)]">
      ...
      <div className="flex gap-3 text-[#F8FAFC]">
        <button className="bg-herobutton-500 p-2 rounded-lg hover:opacity-90 md:p-4 md:text-xl hover:cursor-pointer">
          Start coding
        </button>
        <button className="bg-navbarbackground-500 p-2 rounded-lg border-2 md:p-4 md:text-xl hover:cursor-pointer">
          Learn more
        </button>
      </div>
    </div>
